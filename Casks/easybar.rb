cask "easybar" do
  version "0.40.0"
  sha256 "fcd98ae44db47a236acb85079414827ec8f23b313b07332862ab37764d8e58ac"

  url "https://github.com/gi8lino/easybar/releases/download/v0.40.0/EasyBar-0.40.0.zip"
  name "EasyBar"
