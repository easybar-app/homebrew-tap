cask "easybar" do
  version "0.30.1"
  sha256 "b24b8114f909db2af2e5fa2c94a3cb80a5d8872aaaceb847e4a85723a90fcaa2"

  url "https://github.com/gi8lino/easybar/releases/download/v0.30.1/EasyBar-0.30.1.zip"
  name "EasyBar"
