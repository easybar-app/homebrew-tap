cask "easybar" do
  version "0.28.1"
  sha256 "7bc4dadc1aae6a66a08b357a96b186fb0049f0167c39562009c3a1ecfa1899dd"

  url "https://github.com/gi8lino/easybar/releases/download/v0.28.1/EasyBar-0.28.1.zip"
  name "EasyBar"
